...
function saveProgress() {
  localStorage.setItem("activities_xp", xp);
  localStorage.setItem("activities_level", level);
}

function loadProgress() {
 const savedXP = localStorage.getItem("activities_xp");
const savedLevel = localStorage.getItem("activities_level");
